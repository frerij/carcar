        ...
        <div className="collapse navbar-collapse" id="navbarNavDarkDropdown">
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              <NavLink className="nav-link dropdown-toggle" to="#" id="navbarSalesLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Sales
              </NavLink>
              <ul className="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarSalesLink">
                <li><NavLink  className="dropdown-item" to="sales/new">Add new Sale</NavLink ></li>
                <li><NavLink  className="dropdown-item" to="sales/">List of Sales</NavLink ></li>
                <li><NavLink  className="dropdown-item" to="sales/history">Sales Person History</NavLink ></li>
                <li><NavLink  className="dropdown-item" to="sales/person">New Salesman</NavLink ></li>
